 ...
 */
function darklinefplstheme_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'darklinefplstheme_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.darklinefplstheme-front-page) .entry-title,
...
.colors-custom .darklinefplstheme-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.darklinefplstheme-front-page .panel-content .recent-posts article,
...
.colors-custom.darklinefplstheme-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'darklinefplstheme_custom_colors_css', $css, $hue, $saturation );
}
